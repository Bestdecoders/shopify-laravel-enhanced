...
/**
 * Telegram Commands List Command
 *
 * Usage: /commands - Lists all available commands
 * Usage: /commands [command_name] - Shows detailed help for a specific command
 * Usage: /commands [command_name] -h - Shows detailed help for a specific command
 *
 * Examples:
 * - /commands - Lists all commands
 * - /commands discount - Shows help for discount command
 * - /commands ai - Shows help for ai command
 */
class CommandsListCommand
{
    ...
    public function handle(TelegramService $telegram): void
    {
        ...
        // Remove /commands command prefix
        $commandText = str_replace('/commands', '', $text);
        ...
        try {
            ...
            Log::error('Telegram Commands List Command error', [
                'error' => $e->getMessage(),
                'command' => $commandText,
            ]);
    ...
    protected function listAllCommands(TelegramService $telegram, string $chatId): void
    {
        ...
        $message .= "\nUse <b>/commands [command_name]</b> to get detailed help for a specific command.";
    ...
    protected function showCommandHelp(TelegramService $telegram, string $chatId, string $commandName): void
    {
        ...
        if (!isset($commands[$commandName])) {
            $telegram->sendToChat($chatId, "Command '<b>$commandName</b>' not found. Use /commands to see all available commands.");
            return;
        }
